...
public class SmppProcessingException extends Exception 
{
    ...
    private MessageStatus errorCode;
    ...
    {
        super("SMPP processing error [0x" + HexUtil.toHexString(errorCode.getValue()) + "]" + (msg == null ? "" : " message [" + msg + "]"));
        this.errorCode = errorCode;
    }

    public MessageStatus getErrorCode() 
    {
